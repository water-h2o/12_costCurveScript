...
for i = 1:2:length(in_addresses)
    ...
    hold on
    grid on
    title(['Cost curve: ' in_address_FP(1:3) '\_GP' ... 
          strrep(in_address_FP(4:13),'_','\_')])
    xlabel('$$PC(\mathsf{P})$$','Interpreter','latex')
    ylabel('$$E[Co]$$','Interpreter','latex')
